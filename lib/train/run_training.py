...
def run_training(script_name, config_name, cudnn_benchmark=True, local_rank=-1, save_dir=None, base_seed=None,
                 ...
                 distill=None,prompt=0, script_teacher=None, config_teacher=None):
    ...
    if distill:
        ...
        # prompt type: traj, fusing with feat_vit, iou regression task
        expr_module = importlib.import_module('lib.train.train_script_prompt')
    else:
...
def main():
    ...
    parser.add_argument('--prompt', type=int, choices=[0, 1, 2, 3], default=0)  # prompt type
    ...
    run_training(args.script, args.config, cudnn_benchmark=args.cudnn_benchmark,
                 ...
                 distill=args.distill, prompt=args.prompt, script_teacher=args.script_teacher, config_teacher=args.config_teacher)
