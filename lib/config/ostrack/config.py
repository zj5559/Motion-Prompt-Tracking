...
cfg.PROMPT=edict()
cfg.PROMPT.traj_filter=0.5
cfg.PROMPT.USE_PROMPT=False
cfg.PROMPT.TRAJ_JITTER_PROB=0
cfg.PROMPT.CUTMIX=0.0
cfg.PROMPT.CUTMIX_OCC=0.3
cfg.PROMPT.HIDDEN_DIM=256
cfg.PROMPT.DEC_TYPE=None
cfg.PROMPT.ENC_TYPE=None
cfg.PROMPT.TRACKLEN=30
cfg.PROMPT.SPARSE=3
cfg.PROMPT.PELOG=0
cfg.PROMPT.S_CENTER_JITTER = 3
cfg.PROMPT.S_SCALE_JITTER = 0.25
cfg.PROMPT.FREEZE='full'
cfg.PROMPT.TRUNC=False
cfg.PROMPT.WEIGHT_LABEL_TYPE = 'pred_iou'
cfg.PROMPT.token_loss=False
cfg.PROMPT.alpha=7.23
