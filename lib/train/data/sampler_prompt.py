...
class TrackingSampler(torch.utils.data.Dataset):
    ...
    def __init__(self, datasets, p_datasets, samples_per_epoch, max_gap,
                 ...
                 train_cls=False, pos_prob=0.5,tracklen=30,sparse=1):
        """
        args:
    ...
    def getitem(self):
        ...
        while not valid:
            ...
            try:
                ...
                sparse = random.randint(1, self.sparse)
                search_frames, search_anno, meta_obj_test = dataset.get_frames(seq_id, search_frame_ids[:1], seq_info_dict,traj=True,tracklen=self.tracklen,sparse=sparse)
                cutmix_frames, cutmix_anno, _ = dataset.get_frames(seq_id, search_frame_ids[1:], seq_info_dict)
                ...
                data = TensorDict({'template_images': template_frames,
                                   ...
                                   'cutmix_frames': cutmix_frames,
                                   'cutmix_anno': cutmix_anno['bbox'],
                                   'search_trackdata': search_anno['track_bbox'][0],
                                   'search_trackgt': search_anno['track_gt'][0],
                                   'search_trackvisible': search_anno['track_visible'][0],
    ...
    def sample_seq_from_dataset(self, dataset, is_video_dataset):
        ...
        while not enough_visible_frames:
            ...
            # Sample frames
            seq_info_dict = dataset.get_sequence_info(seq_id,track_data=True)
