...
def motion_jittered_center_crop(frames, box_extract, box_gt, box_traj,search_area_factor, output_sz, masks=None):
    ...
    box_traj_crop = [transform_image_to_crop(a_gt, box_extract[-1], resize_factors[-1], crop_sz, normalize=True)
                      for a_gt in box_traj]

    return frames_crop, box_crop,box_traj_crop, att_mask, masks_crop
