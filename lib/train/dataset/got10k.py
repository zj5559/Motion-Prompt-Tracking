...
class Got10k(BaseVideoDataset):
    ...
    def __init__(self, root=None, image_loader=jpeg4py_loader, split=None, seq_ids=None, data_fraction=None):
        ...
        self.trackdata_path = os.path.join(env_settings().pretrained_networks,'..','traj_data/got10k')
    ...
    def get_sequence_info(self, seq_id,track_data=False):
        ...
        info = {'bbox': bbox, 'valid': valid, 'visible': visible, 'visible_ratio': visible_ratio}
        if track_data:
